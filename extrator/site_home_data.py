    ...
    with open(path, encoding="utf-8") as json_file:
        ...
        for diario in diarios:
            ...
            for ato in diario["atos"]:
                ato = json.loads(ato)
                # Verifique se possui licitação
                if ato.get("possui_licitacao"):
                    detalhe_ano_resumo["num_licitacao"] = detalhe_ano_resumo.get("num_licitacao", 0) + 1
                    detalhe_ano_mes["num_licitacao"] = detalhe_ano_mes.get("num_licitacao", 0) + 1
...
for id_municipio, dado in inicial.items():
    ...
    for ano, detalhe in dado["detalhe"].items():
        ...
        num_licitacao += resumo.get("num_licitacao", 0)
...
inicial['geral']['ranking_licitacao'] = top5("num_licitacao")
