  ...
  return (
    <main className="min-h-screen h-[100%]">
      <div className="flex flex-col items-center justify-between h-[80%] ">
        {Cob}
        <div>
          <h1 className="text-center text-4xl mt-14 font-[PoppinsMedium]">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-center text-xl mt-10 font-[PoppinsSemiBold]">
              O que é Licitação?
            </h1>
        ...
        <img className="w-[12rem] mt-8" src="/images/mapa_ama_cob.png" />
      </div>
    </main>
  );
};
